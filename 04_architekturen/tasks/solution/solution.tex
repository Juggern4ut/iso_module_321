...
\solution{Die Lernenden sollen nicht nur Begriffe wiedergeben, sondern Architektur als Abwägung verstehen: einfache Systeme profitieren oft von einem modularen Monolithen, während Microservices erst bei klaren fachlichen Grenzen, höherer Last oder mehreren autonomen Teams ihren Aufwand rechtfertigen.}
