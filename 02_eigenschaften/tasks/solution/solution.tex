...
\section*{6. CQRS anwenden}
\begin{enumerate}
  \item \solution{CQRS kann sinnvoll sein, weil Lesen und Schreiben sehr unterschiedliche Anforderungen haben: viele schnelle Abfragen auf der einen Seite, wenige aber kritische Käufe auf der anderen.}
  \item \solution{Command Side: Reservieren oder Kaufen von Tickets, Prüfen von Regeln, Verhindern von Überverkäufen, Auslösen fachlicher Events.}
  \item \solution{Query Side: Anzeigen von Veranstaltungen, verfügbaren Plätzen, Filterlisten, Suchresultaten oder Reports.}
  \item \solution{Vorteil: Lese- und Schreibmodell können separat optimiert werden. Nachteil: zusätzliche Komplexität und mögliche Verzögerung zwischen Schreib- und Lesesicht.}
\end{enumerate}
